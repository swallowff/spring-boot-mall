...
import com.cmkj.mall.mapper.cms.CmsPrefrenceAreaProductRelationMapper;
import com.cmkj.mall.mapper.cms.CmsSubjectProductRelationMapper;
import com.cmkj.mall.mapper.pms.*;
import com.cmkj.mall.model.cms.CmsPrefrenceAreaProductRelationExample;
import com.cmkj.mall.model.cms.CmsSubjectProductRelationExample;
import com.cmkj.mall.model.pms.*;
import com.github.pagehelper.PageHelper;
import com.cmkj.mall.dao.*;
import com.cmkj.mall.dto.PmsProductParam;
import com.cmkj.mall.dto.PmsProductQueryParam;
import com.cmkj.mall.dto.PmsProductResult;
import com.cmkj.mall.service.PmsProductService;
...
public class PmsProductServiceImpl implements PmsProductService {
    ...
    public int create(PmsProductParam productParam) {
        ...
        //判断用来判断存放标签的pid，是否为空，不为空就添加
        if (product.getPid()!=null&&product.getPid().size()>0){
                productMapper.insertGoodsTagCentre(product);
        }
        //判断用来判断存放标签的sid，是否为空，不为空就添加
        if (product.getSid()!=null&&product.getSid().size()>0){
            productMapper.insertGoodsServiceCentre(product);
        }
        //会员价格
