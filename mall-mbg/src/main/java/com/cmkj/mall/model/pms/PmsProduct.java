...
public class PmsProduct implements Serializable {
    ...
    @ApiModelProperty(value = "上架状态：0->下架；1->上架; 2->强制下架;")
    ...
    @ApiModelProperty(value = "商品采购地址")
    private String purchaseUrl;

    @ApiModelProperty(value = "商品访问客流量")
    private Integer visitorFlow;
    ...
    public Integer getHotStyleStatus() {
        return hotStyleStatus;
    }

    public void setHotStyleStatus(Integer hotStyleStatus) {
        this.hotStyleStatus = hotStyleStatus;
    }
    ...
    public Long getShowTagId() {
        return showTagId;
    }

    public void setShowTagId(Long showTagId) {
    ...
    public Integer getVisitorFlow() {
        return visitorFlow;
    }

    public void setVisitorFlow(Integer visitorFlow) {
    ...
    public String toString() {
        ...
        sb.append(", hotStyleStatus=").append(hotStyleStatus);
        sb.append(", hotSaleStatus=").append(hotSaleStatus);
        sb.append(", recommandStatus=").append(recommandStatus);
        sb.append(", verifyStatus=").append(verifyStatus);
        sb.append(", showTagId=").append(showTagId);
        ...
        sb.append(", visitorFlow=").append(visitorFlow);
        sb.append(", productVideoUrl=").append(productVideoUrl);
