...
- 导入项目，以maven项目形式导入  
    ![eclipse_import_1.png](https://github.com/cmkjzheng/mall/blob/master/document/resource/eclipse_import_1.png)  
    ![eclipse_import_2.png](https://github.com/cmkjzheng/mall/blob/master/document/resource/eclipse_import_2.png)
- 安装lombok插件，下载地址：https://projectlombok.org/downloads/lombok.jar  
- 下载完后双击，使用java程序打开
- 按照提示选择eclipse.exe的安装路径安装插件，完成后重启Eclipse
- 启动项目：右击com.cmkj.mall.MallAdminApplication的main方法，选择run as Java Application
...
- 创建用户并设置其角色为管理员：mall mall
    ![rabbitmq_install_2.png](https://github.com/cmkjzheng/mall/blob/master/document/resource/rabbitmq_install_2.png)
- 创建virtual host:/mall
    ![rabbitmq_install_3.png](https://github.com/cmkjzheng/mall/blob/master/document/resource/rabbitmq_install_3.png)
- 给mall用户配置范围该virtual host的权限
    ![rabbitmq_install_4.png](https://github.com/cmkjzheng/mall/blob/master/document/resource/rabbitmq_install_4.png)
...
- 启动项目：直接运行com.cmkj.mall.MallAdminApplication的main方法即可
- 接口文档地址：http://localhost:8080/swagger-ui.html

## mall-search

- 启动项目：直接运行com.cmkj.mall.search.MallSearchApplication的main方法即可
...
- 启动mall-portal项目：直接运行com.cmkj.mall.portal.MallPortalApplication的main方法即可
